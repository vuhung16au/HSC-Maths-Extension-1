# HSC Mathematics Extension 1: Collection of Hard Problems
...
This repository contains a curated collection of challenging problems from the HSC Mathematics Extension 1 curriculum, designed to test deep understanding, creative problem-solving skills, and the ability to synthesize multiple mathematical concepts.
...
This collection presents carefully selected problems that represent the level of difficulty and sophistication expected in the most challenging HSC Extension 1 examinations. Each problem is presented with hints to guide thinking, followed by detailed solutions and key takeaways to reinforce learning.

## What This Collection Is About

This collection focuses on **HSC Mathematics Extension 1 (hard problems)**. The problems span various topics including:

- Trigonometric functions and identities
- Inverse trigonometric functions
- Integration techniques and applications
- Combinatorics and probability
- Calculus applications and differential equations
...
- **Students** preparing for HSC Mathematics Extension 1 who want to challenge themselves with difficult problems and develop advanced problem-solving skills
